...
choices = ['ножницы', 'бумага', 'камень', 'ящерица', 'Спок']
results = ['ничья','Руслан', 'Тимур', 'Руслан', 'Тимур']
timurs_choice, ruslans_choice = 'ящерица', 'камень'

def game_result(player1, player2):
    return results[choices.index(player1) - choices.index(player2)]

print(game_result(timurs_choice, ruslans_choice))
