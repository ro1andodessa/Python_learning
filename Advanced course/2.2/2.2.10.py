...
# В первой строке подаётся число 𝑛 – количество холодильников. В последующих 𝑛 строках вводятся строки, содержащие латинские строчные буквы и цифры, в каждой строке от 5 до 100 символов.
...
# test_string = 'a1n1t1o1t1t'

def is_anton_in_string(test_string):
    example = 'antont'
...
print(*(i for i in range(1, int(input()) + 1) if is_anton_in_string(input())), end=' ')
