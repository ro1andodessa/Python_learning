...
# Программа должна вывести максимальное количество показаний, после удаления которых анализ буден произведен верно.

readings = [int(i) for i in input().split()]
print(len(readings) - len(set(readings)))
